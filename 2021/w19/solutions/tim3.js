...
const squareItDeduct17 = n => multiply(n) - 17;
const add15 = n => n + 15;
const add15SquareRootFloor = n => ~~Math.sqrt(add15(n));

module.exports = n => primeNumbers[n] === true ? squareItDeduct17(n) : add15SquareRootFloor(n)
